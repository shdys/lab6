 ...
 <div class="pricing-plans">
					 <div class="wrap">
					 	<div class="price-head">
					 		<h1>This is the result of "Leaving early pay more"</h1>
					 	</div>
						...
						<div class="pricing-grid2" style="margin-left:30%">
							...
							<ul>
								...
								<li class="whyt">people:<a href="#" ><s:property value="act.Number"/></a></li>
								<li>total money:<a href="#"><s:property value="act.Sum"/></a></li>
								<li class="whyt">average payment for normal people:<a href="#"><s:property value="average"/></a></li>
								<li>payment for early leaving people:<a href="#"><s:property value="average*(1+Percent*0.01)"/></a></li>
